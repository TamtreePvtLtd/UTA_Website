  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 p-6 max-w-4xl mx-auto">
      ...
      <div className="flex justify-end gap-2">
        <button type="submit" className="bg-primary hover:bg-transparent border border-primary hover:text-primary text-white transition px-6 py-2 rounded-md">
          {existingStudent ? 'Update' : 'Create'}
        </button>
        <button type="button" onClick={onClose} className="bg-gray-300 hover:bg-transparent border border-gray-400 transition text-black py-2 px-6 rounded-md">
          Cancel
        </button>
      </div>
    </form>
