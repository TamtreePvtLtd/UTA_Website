  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex-grow px-6 py-12 max-w-5xl mx-auto text-gray-800">
        ...
        <p className="mb-6">
          Our use of your data is governed by our <a href="/privacyPolicy" className="text-primary underline">Privacy Policy</a>. Please review it to understand how your data is collected and used.
        </p>
        ...
        <p className="mb-6">
          ...
          <br />📧 Email: universaltamilacademy@gmail.com
