  ...
  return (
    <div className="bg-white rounded-md flex-1 m-4 mt-0 p-1 sm:p-2 md:p-3 lg:p-4">
      ...
      <form onSubmit={handleSubmit} className="mb-6 space-y-2 border-b pb-14">
        ...
        <button disabled={submitting} type="submit" className="bg-primary hover:bg-transparent border border-primary hover:text-primary text-white transition px-4 py-1 rounded-md">
