      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {activeTab === 'language' && (
          <section className="fade-in">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-6 ">Tamil</h2>
            <div className="mb-12">
        ...
        {activeTab === 'science' && (
          <section className="fade-in">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-6 ">The Ancient Science and Inventions of the Tamil</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                <h3 className="text-2xl font-bold text-secondary mb-4 ">Architecture</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                <h3 className="text-2xl font-bold text-secondary mb-4 ">Mathematics and Astronomy</h3>
                <p className="text-black text-md mb-4">
        ...
        {activeTab === 'health' && (
          <section className="fade-in">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-6 ">Tamil Health Research and Medicine</h2>
            ...
            <div className="mb-12">
              <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
                ...
                <div className="md:w-1/2">
                  <h3 className="text-3xl font-bold text-secondary mb-4">Siddha Medicine System</h3>
                  <p className="text-black text-lg mb-4">
        ...
        {activeTab === 'tradition' && (
          <section className="fade-in">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-6 ">Tamil Culture and Heritage</h2>
            
            <div className="mb-12">
              <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
                <div className="md:w-1/2 order-2 md:order-1">
                  <h3 className="text-3xl font-bold text-secondary mb-4">Living Traditions</h3>
                  <p className="text-black text-lg mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                <h3 className="text-2xl font-bold text-secondary mb-4 ">Rituals</h3>
                <p className="text-black text-md mb-4">
              ...
              <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                <h3 className="text-2xl font-bold text-secondary mb-4 ">Traditional Festivals</h3>
                <p className="text-black text-md mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                <div className={`bg-gradient-to-r ${course.color} text-secondary py-4 text-center`}>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:scale-105 transition-transform border border-gray-100">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h4 className="text-black font-semibold">Lakshmi</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:scale-105 transition-transform border border-gray-100">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <div className="text-left">
                  <h4 className="text-black font-semibold">Aravind</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:scale-105 transition-transform border border-gray-100">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <div className="text-left">
                  <h4 className="text-black font-semibold">Priya</h4>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 hover:scale-105 transition-transform border border-gray-100">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <div className="text-left">
                  <h4 className="text-black font-semibold">Kumar</h4>
