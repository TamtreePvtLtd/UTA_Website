        ...
        {activeTab === 'language' && (
          <section className="fade-in">
            ...
            <div className="mb-12">
              ...
              <div className="md:w-1/2">
              <h3 className="text-2xl font-bold text-primary mb-4">Tamil</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                {[
                  ...
                  <div key={index} className="bg-white p-4 rounded-lg shadow">
                    <h4 className="font-bold text-primary font-tamil text-xl">{item.title}</h4>
          ...
          <section className="fade-in">
            ...
            <div className="mb-12">
              <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
                <div className="md:w-1/2 order-2 md:order-1">
                  <h3 className="text-2xl font-bold text-primary mb-4">Medicine & Surgery</h3>
                  <p className="text-gray-700 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-2xl font-bold text-primary mb-4 font-tamil">Architecture</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-2xl font-bold text-primary mb-4 font-tamil">Mathematics and Astronomy</h3>
                <p className="text-gray-700 mb-4">
          ...
          <section className="fade-in">
            ...
            <div className="mb-12">
              <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
                ...
                <div className="md:w-1/2">
                  <h3 className="text-2xl font-bold text-primary mb-4">Siddha Medicine System</h3>
                  <p className="text-gray-700 mb-4">
            ...
            <div className="bg-amber-100 p-6 rounded-lg mb-12">
              <h3 className="text-2xl font-bold text-primary mb-4 font-tamil">Food and Nutrition</h3>
              <p className="text-gray-700 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                {[
                  ...
                  <div key={index} className="bg-white p-4 rounded-lg shadow">
                    <h4 className="font-bold text-primary font-tamil text-lg">{item.title}</h4>
                    <p className="text-sm text-gray-600 mt-2">{item.desc}</p>
                  </div>
                ))}
              </div>
        ...
        {activeTab === 'tradition' && (
          <section className="fade-in">
            ...
            <div className="mb-12">
              <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
                <div className="md:w-1/2 order-2 md:order-1">
                  <h3 className="text-2xl font-bold text-primary mb-4">Living Traditions</h3>
                  <p className="text-gray-700 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-2xl font-bold text-primary mb-4 font-tamil">Rituals</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-2xl font-bold text-primary mb-4 font-tamil">Traditional Festivals</h3>
                <p className="text-gray-700 mb-4">
